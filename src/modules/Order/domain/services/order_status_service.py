...
class OrderStatusService:
    ...
    @staticmethod
    def validate_transition(current_status: OrderStatus, new_status: OrderStatus) -> Tuple[bool, str]:
        """
        ...
        if new_status not in OrderStatusService.VALID_TRANSITIONS[current_status]:
    ...
    def can_cancel(order: Order) -> Tuple[bool, str]:
        ...
        if order.status == OrderStatus.SERVED:
            return False, "No se puede cancelar un pedido que ya fue servido"
